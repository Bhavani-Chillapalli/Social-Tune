...
<div align="center">
  ...
  <p>&nbsp;</p>
  <p align="center"><font size = "36" color = 'white'>Recommend Your Friends</font> </p>
  <div align="center">
        ...
        <form action ="" method = 'POST'>
          <td><label for="search">
            ...
            <div align="center">
              ...
              <p><a href="list.php">See Your List of Recommendation</a></p>
          </div></td>
        </tr>
      </tbody>
      </table>
  ...
  <p>&nbsp;</p>
       ...
       {
       if ($stmt =$mysqli->prepare("Select distinct cid,cname,vname,start_time,concert_date,concert.bname,tickets_sold,price from test.concert,test.r_concert
where r_concert.cid = concsrt.cid"));
