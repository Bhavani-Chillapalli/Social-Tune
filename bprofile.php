  ...
  <tbody>
    <tr>
      ...
      <td width="230"><div align="center">
        <p>  <form action="user_search.php">
          <input name="textfield" type="text" id="textfield" placeholder="Search Friends">
          <input type="submit" name="Search" id="Search" value="Search">     </form>
        </p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
...
<ul>
 <li class='active'><a href="profile.php"><span>Home</span></a></li>
   ...
   <li class='last'><b id = "logout2" ><a href="logout.php"><span>Log Out</span></a></li>
      ...
      <td><div align="center">UPCOMING CONCERTS</div></td>
